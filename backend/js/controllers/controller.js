...
myApp
  ...
  .controller("empCtrl", function ($scope, TemplateService, NavigationService, $timeout, $state, toastr) {
    $scope.template = TemplateService.changecontent("Employee/employee");
    ...
    $scope.reloadpage = function () {
      NavigationService.employeePagination(function (data) {
        console.log("%%%%%%%%%%%%%%%%%%%%%%%", data);
      ...
      NavigationService.empdelete({
        ...
        function (data) {
          if (data.value) {
            ...
            toastr.error("Error in detelting record");
          }
        }
      );
    };
    ...
    $scope.showAllTables = function (data) {
      $scope.formData.page = 1;
      $scope.formData.firstName = data;
      $scope.formData.lastName = data;
      $scope.viewTable();
    ...
    $scope.viewTable = function () {
      ...
      NavigationService.employeePagination($scope.formData, function (
        result
      ) {
        console.log("result.data.results", result.data);
        $scope.employees = result.data.results;
        $scope.totalItems = result.data.totals;
  ...
  .controller("createEmployee", function ($scope, toastr, $stateParams, TemplateService, NavigationService, $timeout, $state) {
    $scope.template = TemplateService.changecontent("Employee/employeedetails");
    $scope.menutitle = NavigationService.makeactive("employee");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    ...
    $scope.counting = function (monthly, annual) {
      if (monthly == "change") {
        $scope.employee.monthlySalary = (annual / 12);
      } else {

        $scope.employee.annualSalary = (monthly * 12);
      }
    };

    $scope.saveData = function (formData, employee) {

      if (formData.$valid) {
        if (employee) {
          NavigationService.empsave($scope.employee, function (data) {
            // console.log(data);
            if (data.value) {
              toastr.success("successfully", "Save Employee");
              $state.go("employee");
            } else {
              toastr.error("Invalid data", "Save Employee");
            }
          });
        }
      } else {
        toastr.error("Error Fill Valid Data");
      }

    };
  })

  .controller("editEmployee", function ($scope, $stateParams, TemplateService, NavigationService, $timeout, $state) {
    $scope.template = TemplateService.changecontent("Employee/employeedetails");
    $scope.menutitle = NavigationService.makeactive("employee");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    ...
    $scope.saveDesignation = function (designation) {
      console.log(designation);
      $scope.employee.designations = designation._id;
    };
    ...
    NavigationService.getOneEmployee({
        _id: $stateParams.id
      },
      function (data) {
    ...
    $scope.counting = function (monthly, annual) {
      if (monthly == "change") {
        ...
        // var b = parseInt(monthly)
        // console.log(typeof monthly, b);
  ...
  .controller("salaryCtrl", function ($scope, TemplateService, NavigationService, $timeout, $state, toastr) {
    $scope.template = TemplateService.changecontent("Salary/salary");
    $scope.menutitle = NavigationService.makeactive("salary");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    $scope.salaries = [];
    ...
    $scope.reloadsalary = function () {
      NavigationService.getsalary(function (data) {
        $scope.salaries = data.data.results;
      });
    };
    ...
    $scope.delete = function (id) {
      NavigationService.salarydelete({
          _id: id
        },
        function (data) {
          if (data.value) {
  ...
  .controller("editSalary", function ($scope, $stateParams, TemplateService, NavigationService, $timeout, $state) {
    $scope.template = TemplateService.changecontent("Salary/salarydetails");
    $scope.menutitle = NavigationService.makeactive("salary");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    $scope.salary = {};
    ...
    NavigationService.getemployees(function (data) {
      $scope.employees = data.data.results;
    });
    $scope.saveEmployee = function (employee) {
      console.log(employee);
      $scope.salary.employees = employee._id;
    };
    ...
    if ($stateParams.id) {
      ...
      NavigationService.getOneSalary({
        _id: $stateParams.id
      }, function (data) {
        $scope.salary = data.data;
        console.log("$scope.salary", $scope.salary);
    ...
    $scope.saveSalary = function () {
      ...
      NavigationService.salarysave($scope.salary, function (data) {
        console.log(data);
  ...
  .controller("providentfundCtrl", function ($scope, TemplateService, NavigationService, $timeout, $state, toastr) {
    $scope.template = TemplateService.changecontent("Providentfund/providentfund");
    $scope.menutitle = NavigationService.makeactive("providentfund");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    $scope.providentfunds = [];


    $scope.reloadprovidentfund = function () {
      NavigationService.getprovidentfund(function (data) {
        $scope.providentfunds = data.data.results;
      });
    };

    $scope.reloadprovidentfund();


    $scope.delete = function (id) {
      NavigationService.pfdelete({
          _id: id
        },
        function (data) {
          if (data.value) {
  ...
  .controller("editProvidentfund", function ($scope, $stateParams, TemplateService, NavigationService, $timeout, $state) {
    $scope.template = TemplateService.changecontent("Providentfund/providentfunddetails");
    $scope.menutitle = NavigationService.makeactive("providentfund");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    $scope.providentfund = {};
    $scope.header = {
      name: "Create Providentfund"
    };


    if ($stateParams.id) {
      $scope.header = {
        name: "Edit Providentfund"
      };

      NavigationService.getOnepf({
        _id: $stateParams.id
      }, function (data) {
        $scope.providentfund = data.data;
        console.log("$scope.providentfund", $scope.providentfund);
    ...
    $scope.savepf = function () {
      console.log($scope.providentfund);
      NavigationService.pfSave($scope.providentfund, function (data) {
        console.log(data);
  ...
  .controller("designationCtrl", function ($scope, TemplateService, NavigationService, $timeout, $state, toastr) {
    $scope.template = TemplateService.changecontent("Designation/designation");
    $scope.menutitle = NavigationService.makeactive("designation");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    $scope.designations = [];

    $scope.designationreload = function () {
      NavigationService.getdesignation(function (data) {
        $scope.designations = data.data.results;
      });
    };

    $scope.designationreload();

    $scope.designationdelete = function (id) {
      NavigationService.deletedesignation({
          _id: id
        },
        function (data) {
          if (data.value) {
  ...
  .controller("createdesignationCtrl", function ($scope, toastr, $stateParams, TemplateService, NavigationService, $timeout, $state) {
    $scope.template = TemplateService.changecontent("Designation/designationdetails");
    $scope.menutitle = NavigationService.makeactive("designationdetails");
    TemplateService.title = $scope.menutitle;
    $scope.navigation = NavigationService.getnav();
    // if (!$stateParams.id) {
    $scope.designation = {};
    ...
    $scope.saveData = function (designation) {
      if (designation) {
        NavigationService.designationsave($scope.designation, function (data) {
          // console.log(data);
          if (data.value) {
            toastr.success("successfully", "Save Designation");
            $state.go("designation");
          } else {
            toastr.error("Invalid data", "Save Designation");
          }
        });
      }
